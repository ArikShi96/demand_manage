...
import { Form, FormControl, Button, Message, Modal, InputNumber, Label, Icon } from 'tinper-bee';
...
class Addcate extends React.Component {
  ...
  render() {
    let { form: { getFieldProps, getFieldError }, showModal, close } = this.props;
    return (
      <Modal
        show={showModal}
        onHide={close}
      >
        ...
        <Modal.Footer>
          <Button onClick={close} colors="secondary" style={{ marginRight: 8 }}>取消</Button>
          <Button onClick={this.addCateFun.bind(this)} colors="primary">确认</Button>
        </Modal.Footer>
      </Modal>
    )
  }
