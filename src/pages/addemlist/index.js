...
class Addentlist extends React.Component {
  ...
  styleBtn(event) {
    if (event === 3) {
      return <Button colors="primary">已通过</Button>;
    } else if (event === 4) {
      return <Button colors="primary">已拒绝</Button>;
    } else {
      return (
        <div>
          <Button
          ...
          <Button colors="primary" onClick={this.adoptMethod.bind(this)}>
            通过
          </Button>
        </div>
      );
    ...
    return (
      <div className="addemandlist">
        <Modal show={showModal} onHide={close}>
          ...
          <Modal.Footer>{this.styleBtn(this.statuid)}</Modal.Footer>
        </Modal>
        ...
        <Modal show={this.state.visible} onHide={this.hideModal.bind(this)}>
          ...
          <Modal.Footer>
            ...
            <Button onClick={this.refuseMethod.bind(this)} colors="primary">
              确认
            </Button>
          </Modal.Footer>
        </Modal>
