...
class Template extends React.Component {
        ...
        return (
          <Fragment>
            <a
              ...
              onClick={this.edit.bind(null, record)}
            >
              编辑
            </a>
          </Fragment>
  ...
  getSearch = (pageIndex = 1, pageSize) => {
    ...
    fetch(
      myapi.BASE_URL +
        `/market/chanpay/getOperatorBankList?bankName=${bankName}&b2b=${b2b}&debit=${debit}&credit=${credit}&pageIndex=${pageIndex}&pageSize=${_pageSize}`,
      {
        method: "GET",
        mode: "cors",
        headers: {
      ...
      <Fragment>
          ...
          <Fragment>
            ...
            >
              <FormList layoutOpt={{ md: 4, xs: 4 }}>
                <FormList.Item label="银行名称" labelCol={100}>
                  <FormControl
                ...
                <FormList.Item label="银行网银" labelCol={100}>
                  <Select
                    className="search-item"
                ...
                <FormList.Item label="个人储蓄卡" labelCol={100}>
                  <Select
                    className="search-item"
                ...
                <FormList.Item label="个人信用卡" labelCol={100}>
                  <Select
                    className="search-item"
        ...
        <Modal show={showModal} onHide={this.close}>
          ...
          <Modal.Body>
            <div>
              <Form>
                <FormItem>
                  <Label>
                    <Icon type="uf-mi" className="mast"></Icon>银行卡标志
                  </Label>
                  <FormControl
                  ...
                  />
                  <span className="error">{getFieldError("bankCode")}</span>
                </FormItem>
                <FormItem>
                  <Label>
                    <Icon type="uf-mi" className="mast"></Icon>银行卡名称
                  </Label>
                  <FormControl
                  ...
                  />
                  <span className="error">{getFieldError("bankName")}</span>
                </FormItem>
                <FormItem>
                  <Label>
                    <Icon type="uf-mi" className="mast"></Icon>银行LOGO
                  </Label>
                  <div className="upload-logo">
                    <Upload {...this.uploadProps}>
                      ...
                      <span className="txt-tip">
                        图片大小为260px*70px，图片类型为jpg、png
                      </span>
                    </Upload>
                  </div>
                  {bankError ? (
                    <span className="error">请输入银行卡LOGO</span>
                  ) : null}
                </FormItem>
                {imgUrl ? (
                  <FormItem>
                ...
                <FormItem>
                  <Label>
                    <Icon type="uf-mi" className="mast"></Icon>支持网银
                  </Label>
                  <Radio.RadioGroup
                ...
                <FormItem>
                  <Label>
                    <Icon type="uf-mi" className="mast"></Icon>支持个人储蓄卡
                  </Label>
                  <Radio.RadioGroup
                    // selectedValue={this.state.selectedValue2}
                    {...getFieldProps("debit", {
                ...
                <FormItem>
                  <Label>
                    <Icon type="uf-mi" className="mast"></Icon>支持个人信用卡
                  </Label>
                  <Radio.RadioGroup
                    // selectedValue={this.state.selectedValue2}
                ...
                <FormItem>
                  <Label>
                    <Icon type="uf-mi" className="mast"></Icon>银行客服热线
                  </Label>
                  <FormControl
                    {...getFieldProps("phone", {
                      validateTrigger: "onBlur",
          ...
          <Modal.Footer>
            ...
            <Button onClick={this.handleOk} colors="primary">
              确认
            </Button>
          </Modal.Footer>
        </Modal>
