...
class CateModel extends React.Component {
  ...
  getlistinfo(e = 0, ps = 10) {
    fetch(
      myapi.BASE_URL + `/market/requirement/blacklist/list?pn=${e}&ps=${ps}`,
      {
        method: "GET",
        headers: {
  ...
  moveFun() {
    ...
    fetch(
      myapi.BASE_URL +
        `/market/requirement/blacklist/${this.state.moveID}/remove`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
        ...
        <Content style={{ width: "100%" }}>
          ...
          >
            ...
            <Modal.Footer>
              ...
              <Button onClick={this.moveFun.bind(this)} colors="primary">
                确认
              </Button>
            </Modal.Footer>
          </Modal>
