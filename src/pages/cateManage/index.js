import { Button, Message, FormControl, Pagination, Table, Form, Icon, Modal, InputNumber, Label } from 'tinper-bee';
...
class CateModel extends React.Component {
        ...
        { title: "排序", dataIndex: "sort", key: "sort" },
        {
            ...
            render: (value, record, index) => {
                return <Fragment>
                    ...
                    <a style={{ marginLeft: "10px" }} onClick={this.showEdit.bind(null, record.id)}>编辑</a>
                    <a style={{ marginLeft: "10px" }} onClick={this.delelistfun.bind(this, record.id, index)}>删除</a>
                </Fragment>
            }
        },
    ];
    ...
    close = () => {
        this.setState({ showModal: false, showEditModal: false, showViewModal: false });
    }
    ...
    getEditDetail(id) {
        fetch(myapi.BASE_URL + `/market/requirement/domain/detail/${id}`, {
            ...
            .then((response) => {
                ...
                this.props.form.setFieldsValue({ "domainName": currentedit.domainName, "sort": currentedit.sort })
                return true
            })
    ...
    render() {
        ...
        let { form: { getFieldProps, getFieldError } } = this.props;
        return (
            <Fragment>
                ...
                <Content style={{ width: '100%' }}>
                    ...
                    <div className="button-zone"><Button colors="primary" onClick={this.show}>新增</Button></div>
                ...
                <div className="addemandlist">
                    ...
                    >
                                ...
                                <FormItem>
                                    ...
                                    <FormControl
                                        {...getFieldProps('domainName', {
                                            ...
                                            rules: [{
                                                required: true, message: '请输入领域名称',
                                            }],
                                        })}
                                    />
                                    <span className='error'>
                                        {getFieldError('domainName')}
                                    </span>
                                </FormItem>
                                <FormItem>
                        ...
                        <Modal.Footer>
                            ...
                            <Button onClick={this.addCateFun.bind(this)} colors="primary">保存</Button>
                        </Modal.Footer>
                    </Modal>
                </div>
