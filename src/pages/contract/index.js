...
class Contracts extends React.Component {
  ...
  settledColumns = [
    ...
    },
    {
      ...
      render: (value, record) => {
        return (
          <a
            onClick={this.handleSettledClick.bind(
              null,
              record.status,
              record.contractNum
            )}
          >
            {record.status === "3" ? "下载合同" : "查看合同"}
          </a>
        );
      },
    },
  ...
  getSettledSearch = (pageIndex = 0, pageSize = 10) => {
    ...
    let newData = {
      contractNum: contractNumSettled,
  ...
  settledService = (status, num) => {
    ...
    let url =
      status === "3"
        ? myapi.BASE_URL + `/market/contract/download/${num}`
        : myapi.BASE_URL + `/market/contract/view/${num}`;
    fetch(url, {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  orderService = (status, num) => {
    ...
    let url =
      status === "4"
        ? myapi.BASE_URL + `/market/contract/downloadOrderContract/${num}`
        : myapi.BASE_URL + `/market/contract/viewOrderContract/${num}`;
    fetch(url, {
      method: "GET",
      mode: "cors",
      headers: {
            ...
            <Fragment>
              ...
              >
                <FormList layoutOpt={{ md: 4, xs: 4 }}>
                  <FormList.Item label="合同编号" labelCol={100}>
                    <FormControl
                  ...
                  <FormList.Item label="合同状态" labelCol={100}>
                    <Select
                      className="search-item"
                  ...
                  <FormList.Item label="申请企业" labelCol={100}>
                    <FormControl
                      className="search-item"
                      value={applyEnt}
            ...
            <Fragment>
              ...
              >
                <FormList layoutOpt={{ md: 4, xs: 4 }}>
                  ...
                  <FormList.Item label="用户名称" labelCol={100}>
                    <FormControl
                      className="search-item"
                      value={userName}
                  ...
                  <FormList.Item label="企业名称" labelCol={100}>
                    <FormControl
                      className="search-item"
                      value={entName}
                  ...
                  <FormList.Item label="合同状态" labelCol={100}>
                    <Select
                      className="search-item"
                      onChange={this.handleChange.bind(null, "statusSettled")}
                      value={statusSettled}
                    >
                      <Option value="">全部</Option>
