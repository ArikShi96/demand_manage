...
class OrderDetail extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(
      myapi.BASE_URL + `/market/yonyoucloud/operationOne?agreementNum=${id}`,
      {
        method: "GET",
        mode: "cors",
        headers: {
      ...
      data.map((item) => {
        node.push(
          <div className="isv-detail-zone-date block">
            <div className="isv-detail-zone-item-value">{item}</div>
          </div>
        );
      });
      return node;
              ...
              {basicInfo.map((item) => {
                return (
                  <div className="isv-detail-zone-item">
                    ...
                    {item.value == "data.orderStatusDesc" &&
                    payMode == "offline" ? (
                      ...
                      <div className="isv-detail-zone-item-value">
                        {this.renderPayMode(allValue, item.value)}
                      </div>
                    )}
                  </div>
                );
  ...
  onClick = () => {
    ...
    fetch(
      myapi.BASE_URL + `/market/yonyoucloud/operator/confirm/${agreementNum}`,
      {
        method: "GET",
        mode: "cors",
        headers: {
  ...
  payConfirm = () => {
    let { agreementNum } = this.state;
    fetch(
      myapi.BASE_URL + `/market/yonyoucloud/confirmPayment/${agreementNum}`,
      {
        method: "GET",
        mode: "cors",
        headers: {
