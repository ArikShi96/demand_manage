import { Form, FormControl, Button, Select, Pagination, Table, Message, Modal, Label, Icon, Upload, Timeline } from 'tinper-bee';
...
class Template extends React.Component {
    ...
    columns = [
        { title: "合同模板ID", dataIndex: "templateNum", key: "templateNum", width: "10%" },
        { title: "合同模板名称", dataIndex: "templateName", key: "templateName", width: "20%" },
        {
            title: "模板创建时间", dataIndex: "createTime", key: "createTime", width: "15%",
            render: (value) => {
        ...
        { title: "模板级别", dataIndex: "templateLevel", key: "templateLevel", width: "10%" },
        {
            title: "操作", dataIndex: "operation", key: "operation", width: "10%",
            render: (value, record) => {
                return <Fragment>
                    <a onClick={this.enable.bind(null, record.status, record.templateNum)}>{record.status === "1" ? "停用" : "启用"}</a>
                    <a style={{ marginLeft: "10px" }} onClick={this.getDateService.bind(null, record.id)}>查看日志</a>
                </Fragment>
            }
        },
    ];
    ...
    settledColumns = [
        ...
        { title: "模板名称", dataIndex: "templateName", key: "templateName", width: "15%" },
        {
            title: "模板分类", dataIndex: "templateCategory", key: "templateCategory", width: "10%",
            render: (value) => {
                return <span>{value === "1" ? "入驻合同" : "订单合同"}</span>
            }
        },
        {
            title: "到期日", dataIndex: "expireTime", key: "expireTime", width: "10%",
            render: (value) => {
        ...
        { title: "模板ID", dataIndex: "templateNum", key: "templateNum", width: "15%" },
        {
        ...
        },
        {
            title: "操作", dataIndex: "operation", key: "operation", width: "10%",
            render: (value, record) => {
                return record.status === "1" ? <a onClick={this.edit.bind(null, record)}>修改</a> : null
            }
        },
    ];
    ...
    getSearch = (pageIndex = 0, pageSize = 10) => {
        ...
        let newData = { templateName, isvName, status, size: pageSize, page: pageIndex, templateCategory: 2 }
        fetch(myapi.BASE_URL + `/market/contract/getTemplateList`, {
            method: 'POST',
            mode: 'cors',
            body: JSON.stringify(newData),
    ...
    render() {
        let { dataSource, templateName, isvName, status, selectStatus, activeTabKey, activeTemPage, activePage, upLoadData, logData, showDateModal, showModal } = this.state;
            ...
            <Fragment>
                ...
                <Content style={{ width: '100%' }}>
                    <div className="tabList">
                        <div onClick={this.handleTabChange.bind(null, 1)} className={activeTabKey == 1 ? "active" : ""}>订单合同模板</div>
                        <div onClick={this.handleTabChange.bind(null, 2)} className={activeTabKey == 2 ? "active" : ""}>入驻合同模板</div>
                    </div>
                    {
                        activeTabKey == 1 ?
                            <Fragment>
                        ...
                        activeTabKey == 2 ?
                            <Fragment>
                                <div className="button-zone">
                                    <Button colors="primary" onClick={this.open}>添加合同模板</Button>
                                </div>
                ...
                <Modal
                    ...
                    <Modal.Body>
                        <div>
                            <Form>
                                <FormItem>
                                    <Label><Icon type="uf-mi" className='mast'></Icon>模板名称</Label>
                                    <FormControl
                                ...
                                <FormItem>
                                    <Label><Icon type="uf-mi" className='mast'></Icon>模板分类</Label>
                                    <Select
                                        {
                                ...
                                <FormItem>
                                    <Label><Icon type="uf-mi" className='mast'></Icon>模板状态</Label>
                                    <Select
                                        {
                                ...
                                <FormItem >
                                    <Label><Icon type="uf-mi" className='mast'></Icon>上传模板</Label>
                                ...
                                <FormItem>
                                    <Label style={{ marginTop: "6px", verticalAlign: "top" }}><Icon type="uf-mi" className='mast'></Icon>合同到期日</Label>
                                    <DatePicker
                                        {
                    ...
                    <Modal.Footer>
                        ...
                        <Button onClick={this.upLoad} colors="primary">确认</Button>
                    </Modal.Footer>
                </Modal>
